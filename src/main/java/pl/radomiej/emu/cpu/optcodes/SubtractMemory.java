...
public class SubtractMemory implements Optcode<PureCPU> {
    final private int a;
    final private int b;
    final private int c;

    public SubtractMemory(int a, int b, int c) {
        this.a = a;
        this.b = b;
        this.c = c;
    }
    ...
    public void execute(PureCPU pureCPU) {
        ...
        PureByte result = U2BitsMathHelper.subtract(rA, rB, pureCPU.getFlags());
